Shader "Unreal/MI_BrickStone02A"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[8] = float4(-750780416.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-754343936.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-752459776.000000,0.000000,-0.000000,0.000000);//(Unknown)
