Shader "Unreal/MI_Stereobate02B"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.500000,0.500000,0.500000,0.500000);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(-753586176.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-751702016.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(-752439296.000000,0.000000,-0.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, Local9, 3);
	MaterialFloat4 Local11 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,Local9,View.MaterialTextureMipBias));
	...
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, Local9, 0);
	MaterialFloat4 Local16 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,Local9,View.MaterialTextureMipBias));
	...
	MaterialFloat Local23 = MaterialStoreTexCoordScale(Parameters, Local9, 1);
	MaterialFloat4 Local24 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,Local9,View.MaterialTextureMipBias));
	...
	MaterialFloat Local27 = MaterialStoreTexCoordScale(Parameters, Local9, 2);
	MaterialFloat4 Local28 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,Local9,View.MaterialTextureMipBias));
