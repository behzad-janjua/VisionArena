...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(2.959455,2.812977,2.812977,2.959455);//(Unknown)
	...
	Material.PreshaderBuffer[9] = float4(-750780416.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-754343936.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(-752459776.000000,0.000000,-0.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = LWCMultiplyVector(MaterialFloat3(1.00000000,0.00000000,0.00000000), GetInstanceToWorld(Parameters));
	MaterialFloat3 Local1 = (((MaterialFloat3)0.00000000) - Local0);
	MaterialFloat Local2 = length(Local1);
	MaterialFloat3 Local3 = LWCMultiplyVector(MaterialFloat3(0.00000000,1.00000000,0.00000000), GetInstanceToWorld(Parameters));
