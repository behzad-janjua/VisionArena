Shader "Unreal/MI_Stereobate01B"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[8] = float4(-751968256.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-753872896.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-754876416.000000,0.000000,-0.000000,0.000000);//(Unknown)
