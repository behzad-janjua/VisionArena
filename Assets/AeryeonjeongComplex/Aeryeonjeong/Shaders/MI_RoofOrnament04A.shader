Shader "Unreal/MI_RoofOrnament04A"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[8] = float4(-754896896.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-753258496.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-754159616.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-752173056.000000,0.000000,-0.000000,0.000000);//(Unknown)
