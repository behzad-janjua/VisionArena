Shader "Unreal/MI_BrickStone10A_Tile"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.793787,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.500000,0.500000);//(Unknown)
	...
	Material.PreshaderBuffer[8] = float4(-751190016.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-754753536.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-753442816.000000,0.000000,-0.000000,0.000000);//(Unknown)
