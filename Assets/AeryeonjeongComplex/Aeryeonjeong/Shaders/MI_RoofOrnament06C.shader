Shader "Unreal/MI_RoofOrnament06C"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[8] = float4(-753074176.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-752091136.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-751005696.000000,0.000000,-0.000000,0.000000);//(Unknown)
