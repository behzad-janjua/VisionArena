Shader "Unreal/MI_BrickStone08A"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[8] = float4(-752050176.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-753831936.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-751681536.000000,0.000000,-0.000000,0.000000);//(Unknown)
