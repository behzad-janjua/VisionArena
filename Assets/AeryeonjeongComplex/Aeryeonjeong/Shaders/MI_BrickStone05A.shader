Shader "Unreal/MI_BrickStone05A"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.496000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[8] = float4(-753094656.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-753135616.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-754323456.000000,0.000000,-0.000000,0.000000);//(Unknown)
