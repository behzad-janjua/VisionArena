Shader "Unreal/MI_BrickStone04B"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[9] = float4(-750985216.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-751169536.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(-753197056.000000,0.000000,-0.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = LWCMultiplyVector(MaterialFloat3(0.00000000,1.00000000,0.00000000), GetInstanceToWorld(Parameters));
	MaterialFloat3 Local1 = (((MaterialFloat3)0.00000000) - Local0);
	MaterialFloat Local2 = length(Local1);
	MaterialFloat3 Local3 = LWCMultiplyVector(MaterialFloat3(1.00000000,0.00000000,0.00000000), GetInstanceToWorld(Parameters));
	MaterialFloat3 Local4 = (((MaterialFloat3)0.00000000) - Local3);
	MaterialFloat Local5 = length(Local4);
	MaterialFloat2 Local6 = (MaterialFloat2(Local2,Local5) * Material.PreshaderBuffer[1].zw);
	MaterialFloat2 Local7 = Parameters.TexCoords[0].xy;
	MaterialFloat2 Local8 = (Material.PreshaderBuffer[2].zw + DERIV_BASE_VALUE(Local7));
	MaterialFloat2 Local9 = (Local6 * DERIV_BASE_VALUE(Local8));
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, MaterialFloat2(Local9.g,Local9.r), 3);
	MaterialFloat4 Local11 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_0,Material_Texture2D_0Sampler,MaterialFloat2(Local9.g,Local9.r),View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 3);
	MaterialFloat3 Local13 = lerp(Local11.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),Material.PreshaderBuffer[3].y);
	...
	MaterialFloat3 Local14 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[4].xyz,Material.PreshaderBuffer[3].z);
	MaterialFloat Local15 = MaterialStoreTexCoordScale(Parameters, MaterialFloat2(Local9.g,Local9.r), 0);
	MaterialFloat4 Local16 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,MaterialFloat2(Local9.g,Local9.r),View.MaterialTextureMipBias));
	MaterialFloat Local17 = MaterialStoreTexSample(Parameters, Local16, 0);
	MaterialFloat3 Local18 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000)),Material.PreshaderBuffer[5].x),((MaterialFloat3)0.00000000),Local16.rgb);
	MaterialFloat3 Local19 = (Local18 + Local16.rgb);
	MaterialFloat Local20 = dot(Local19,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local21 = lerp(Local19,((MaterialFloat3)Local20),Material.PreshaderBuffer[5].y);
	MaterialFloat3 Local22 = (Local21 * Material.PreshaderBuffer[7].xyz);
	MaterialFloat Local23 = MaterialStoreTexCoordScale(Parameters, MaterialFloat2(Local9.g,Local9.r), 1);
	MaterialFloat4 Local24 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,MaterialFloat2(Local9.g,Local9.r),View.MaterialTextureMipBias));
	MaterialFloat Local25 = MaterialStoreTexSample(Parameters, Local24, 1);
	MaterialFloat3 Local26 = (Local24.rgb * ((MaterialFloat3)Material.PreshaderBuffer[7].w));
	MaterialFloat Local27 = MaterialStoreTexCoordScale(Parameters, MaterialFloat2(Local9.g,Local9.r), 2);
	MaterialFloat4 Local28 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,MaterialFloat2(Local9.g,Local9.r),View.MaterialTextureMipBias));
	MaterialFloat Local29 = MaterialStoreTexSample(Parameters, Local28, 2);
	MaterialFloat3 Local30 = (Local28.rgb * ((MaterialFloat3)Material.PreshaderBuffer[8].x));
