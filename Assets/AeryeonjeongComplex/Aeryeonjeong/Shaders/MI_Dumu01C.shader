...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[5] = float4(1.000000,0.370000,0.016000,1.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,0.370000,0.016000,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(11.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(-750944256.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-753299456.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-752705536.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[12] = float4(-754077696.000000,0.000000,-0.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local1 = (Material.PreshaderBuffer[1].zw + DERIV_BASE_VALUE(Local0));
	...
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 0);
	MaterialFloat4 Local9 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,Material_Texture2D_1Sampler,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias));
	MaterialFloat Local10 = MaterialStoreTexSample(Parameters, Local9, 0);
	MaterialFloat3 Local11 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000)),Material.PreshaderBuffer[4].x),((MaterialFloat3)0.00000000),Local9.rgb);
	...
	MaterialFloat3 Local14 = lerp(Local12,((MaterialFloat3)Local13),Material.PreshaderBuffer[4].y);
	MaterialFloat3 Local15 = (Local14 * Material.PreshaderBuffer[6].xyz);
	MaterialFloat Local16 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 1);
	MaterialFloat4 Local17 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,Material_Texture2D_2Sampler,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias));
	MaterialFloat Local18 = MaterialStoreTexSample(Parameters, Local17, 1);
	MaterialFloat3 Local19 = (Local17.rgb * ((MaterialFloat3)Material.PreshaderBuffer[6].w));
	MaterialFloat Local20 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local2), 2);
	MaterialFloat4 Local21 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,Material_Texture2D_3Sampler,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias));
	MaterialFloat Local22 = MaterialStoreTexSample(Parameters, Local21, 2);
	MaterialFloat3 Local23 = (Local21.rgb * ((MaterialFloat3)Material.PreshaderBuffer[7].x));
	MaterialFloat4 Local24 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_4,Material_Texture2D_4Sampler,DERIV_BASE_VALUE(Local2),View.MaterialTextureMipBias));
	MaterialFloat Local25 = MaterialStoreTexSample(Parameters, Local24, 0);

	PixelMaterialInputs.EmissiveColor = Local7;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local24.rgb;
