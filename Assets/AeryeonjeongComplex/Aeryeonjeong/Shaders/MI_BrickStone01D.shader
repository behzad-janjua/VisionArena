Shader "Unreal/MI_BrickStone01D"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.900000,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[8] = float4(-752726016.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-752603136.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-752930816.000000,0.000000,-0.000000,0.000000);//(Unknown)
...
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local6 = (MaterialFloat2(Local2,Local5) * ((MaterialFloat2)Material.PreshaderBuffer[1].x));
	MaterialFloat2 Local7 = Parameters.TexCoords[0].xy;
	MaterialFloat2 Local8 = (Material.PreshaderBuffer[2].xy + DERIV_BASE_VALUE(Local7));
	...
	MaterialFloat3 Local13 = lerp(Local11.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),Material.PreshaderBuffer[2].w);
	...
	MaterialFloat3 Local18 = RotateAboutAxis(MaterialFloat4(normalize(MaterialFloat3(1.00000000,1.00000000,1.00000000)),Material.PreshaderBuffer[4].y),((MaterialFloat3)0.00000000),Local16.rgb);
	...
	MaterialFloat3 Local21 = lerp(Local19,((MaterialFloat3)Local20),Material.PreshaderBuffer[4].z);
	MaterialFloat3 Local22 = (Local21 * Material.PreshaderBuffer[6].xyz);
	...
	MaterialFloat3 Local26 = (Local24.rgb * ((MaterialFloat3)Material.PreshaderBuffer[6].w));
	...
	MaterialFloat3 Local30 = (Local28.rgb * ((MaterialFloat3)Material.PreshaderBuffer[7].x));
