Shader "Unreal/MI_RoofOrnament03A"
{
	Properties
	{
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[7] = float4(1.500000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(-751661056.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[9] = float4(-754384896.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(-752132096.000000,0.000000,-0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[11] = float4(-753954816.000000,0.000000,-0.000000,0.000000);//(Unknown)
